...
from Backend.JarvisIntros import is_intro_request, get_introduction
...
def ChatBot(Query):
    ...
    # Check if the query is an introduction request
    if is_intro_request(Query):
        return get_introduction(Query)
